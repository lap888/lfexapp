...
export default class Currency extends Component {
    ...
    renderItem = (item, index) => {
        return (
            <TouchableOpacity key={index} style={styles.item}  onPress={() => Actions.push('FlowDetails', {data: item, type: 'currency'})}>
                        ...
                        ListHeaderComponent={() => {
                            return (
                                <View style={{height: 80, justifyContent: 'center', paddingHorizontal: 10, borderBottomWidth: 10, borderBottomColor: Colors.C13}}>
                                    <Text style={{fontSize: 13, color: Colors.C10}}>币币总账户资产折合</Text>
