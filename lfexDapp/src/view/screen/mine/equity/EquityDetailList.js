                ...
                <View style={{flexDirection: 'row', height: 40, backgroundColor: Colors.White}}>
                    <TouchableOpacity style={{flex: 1, alignItems: 'center' }} onPress={() => this.select(1)}>
                        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ color: this.state.type == 1 ? Colors.mainTab : Colors.C12,}}>股权记录</Text>
                        </View>
                        <View style={{height: 2, width: 80, backgroundColor: this.state.type == 1 ? Colors.mainTab : Colors.White}}/>
                    </TouchableOpacity>
                    <TouchableOpacity style={{flex: 1, alignItems: 'center' }} onPress={() => this.select(2)}>
                        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ color: this.state.type == 2 ? Colors.mainTab : Colors.C12,}}>分红</Text>
                        </View>
                        <View style={{height: 2, width: 80, backgroundColor: this.state.type == 2 ? Colors.mainTab : Colors.width}}/>
                    </TouchableOpacity>
                    <TouchableOpacity style={{flex: 1, alignItems: 'center' }} onPress={() => this.select(3)}>
                        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ color: this.state.type == 3 ? Colors.mainTab : Colors.C12,}}>现金分红</Text>
                        </View>
                        <View style={{height: 2, width: 80, backgroundColor: this.state.type == 3 ? Colors.mainTab : Colors.width}}/>
                    </TouchableOpacity>
                </View>
                <View style={{flex: 1}}>
                    {this.state.data ?
