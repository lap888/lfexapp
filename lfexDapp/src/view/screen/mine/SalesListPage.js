 ...
 * @Last Modified time: 2020-09-16 14:51:34
 */
...
class SalesListPage extends Component {
    ...
    confirmObtainedBuyTransaction() {
        ...
        Send(`api/Trade/CancleTrade?title=${this.props.title}&orderNum=${this.state.itemId}&tradePwd=${this.state.tradePwd}`, {}, 'get').then(res => {
            if (res.code == 200) {
                this.onHeaderRefresh();
...
const Styles = StyleSheet.create({
    ...
    modalBody: {
        ...
        backgroundColor: Colors.exchangeBg,
