    ...
    renderItem(item, index) {
        ...
        return (
            <TouchableOpacity onPress={() => Actions.MessageDetail({ msgData: item, flag: "mine" })}>
                <View style={{ height: 56, marginHorizontal: 15, margin: 1, marginTop: 10, flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.C8, borderWidth: 1, borderColor: Colors.main, borderRadius: 5 }}>
