...
const OPTIONS = [
    ...
    { key: 1, name: "团队果核", route: "teamCandyH" },
    { key: 2, name: "大区果核", route: "bigCandyH" },
    { key: 3, name: "小区果核", route: "littleCandyH" },
];
                                ...
                                <TouchableOpacity key={key} style={{ flexDirection: 'row' }} onPress={() => this.onChangeSequence(key)}>
                                    ...
                                    <View style={{ justifyContent: 'center' }}>
                                        {(itemSelected && order === 'desc') ?
                                            <FontAwesome name="arrow-up" color={Colors.mainTab} size={9} />
                                            :
                                            <FontAwesome name="arrow-up" color={Colors.C10} size={9} />
                                        }
                                        {(itemSelected && order === 'asc') ?
                                            <FontAwesome name="arrow-down" color={Colors.mainTab} size={9} />
                                            :
