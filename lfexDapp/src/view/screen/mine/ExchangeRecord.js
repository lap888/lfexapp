    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: Colors.White }}>
                <Header leftIconColor={{ color: Colors.titleMainTxt }} title={`${this.props.coinType}交易记录`} statusBarBackgroundColor={Colors.titleMain} titleStyle={{ color: Colors.titleMainTxt, fontSize: 18, fontWeight: 'bold' }} backgroundColor={Colors.titleMain} />
