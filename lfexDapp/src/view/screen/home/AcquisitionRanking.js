        ...
        return (
            <RefreshListView
                ...
                renderItem={({ item, index }) =>
                    // <View style={}>
                        <LinearGradient style={[{ flex: 1 }, Styles.miningItem]} colors={[Colors.mainTab, Colors.LightG]} start={{ x: 1, y: 0 }} end={{ x: 0, y: 0 }}>
                ...
                <View style={{flexDirection: 'row', height: 50, borderBottomWidth: 1, borderBottomColor: Colors.C13}}>
                    <TouchableOpacity style={{flex: 1, alignItems: 'center' }} onPress={() => this.select(0)}>
                        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={[this.state.type == 0 ? { color: Colors.mainTab, fontSize: 18 } : { color: Colors.C11, fontSize: 14 }]}>日榜</Text>
                        </View>
                    ...
                    <TouchableOpacity style={{flex: 1, alignItems: 'center' }} onPress={() => this.select(1)}>
                        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={this.state.type == 1 ? { color: Colors.mainTab, fontSize: 18 } : { color: Colors.C11, fontSize: 14 }}>月榜</Text>
                        </View>
