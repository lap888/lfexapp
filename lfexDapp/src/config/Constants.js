...
const gemRecordArr_Mock = [
    { id: 0, description: "任务领取", createdAt: "2019-12-27 12:00", num: 0.366 },
    { id: 1, description: "任务领取", createdAt: "2019-12-26 12:00", num: 0.366 },
    { id: 2, description: "出售1个手续费0.5", createdAt: "2019-12-26 11:00", num: -1.5 }
];
...
const activityPList_Mock = [
    ...
    { id: 3, createdAt: '2019-12-28 12:23', content: '出售一个', rep: -1 }
];
...
const CandyP_Rule = {
    ...
    rules: [
        {
            key: '0', title: `果皮价值`, text: `LV1卖一个扣1.50跟1.50果皮\r\nLV2卖一个扣1.35跟1.35果皮\r\nLV3卖一个扣1.30跟1.30果皮\r\nLV4卖一个扣1.28跟1.28果皮\r\nLV5卖一个扣1.25跟1.25果皮\r\n同时扣除！缺一不可！`
        },
        {
...
// 首页功能Buttun
const HOME_OPTIONS = [
    { key: 1, name: "新手指南", route: 'College', icon: 'graduation-cap' },
    { key: 0, name: "任务商店", route: 'Task', icon: 'tasks' },
    // { key: 2, name: "拉新排行", route: 'PushUserBang', icon: 'user-md' },
    // { key: 3, name: "我的团队", route: 'MyTeam', icon: 'steam-square' }
    { key: 8, name: "收购排行", route: 'AcquisitionRanking', icon: 'user-md', image: '' },
    { key: 6, name: "一键加油", route: 'YouKa', icon: 'barcode', image: '' },
    { key: 7, name: "话费充值", route: 'TelphoneRecharge', icon: 'flash', image: '' },
...
const HOME_OPTIONS2 = [
    ...
    // { key: 6, name: "幸运夺宝", route: 'PushUserBang', icon: 'comments' },
    { key: 6, name: "交易大厅", route: 'Otc', icon: 'comments' },
    { key: 8, name: "分享排行", route: 'BuyCandyBang', icon: 'trophy' },
    { key: 7, name: "哟哟抽奖", route: 'GoToReward', icon: 'globe', image: "require('../../images/GoToWard.gif')" }
];
const HOME_OPTIONS3 = [
...
//首页预加载bar
let PROFILE_BAR = [
    { key: "candyNum", title: "", router: "CandyDetail" },
...
// 4. 等级：四星达人 要求：直推实名20人且团队果核25000点且小区果核10000点 奖励：一个超级任务且全球交易手续费5%
// 星级达人升级指南
const STAR_LEVEL_DETAILS = [
    {
        key: 0, name: "一星达人", reward: "奖励：一个初级任务且全球交易手续费5%", request: `直推实名20人且团队果核500点`
    },
    {
        key: 1, name: "二星达人", reward: "奖励：一个中级任务且全球交易手续费20%", request: `直推实名20人且团队果核2000点且小区果核400点`
    },
    {
        key: 2, name: "三星达人", reward: "奖励：一个高级任务且全球交易手续费15%", request: `直推实名20人且团队果核8000点且小区果核2000点`
    },
    {
        key: 3, name: "四星达人", reward: "奖励：一个超级任务且全球交易手续费5%", request: `直推实名20人且团队果核100000点且小区果核25000点`
    },
    { key: 4, name: "团队果核", reward: "", request: "团队实名成员越多团队果核越多 团队成员开任务越多团队果核越多 团队成员无任务则相应减去团队果核" },
    { key: 5, name: "大区果核", reward: "", request: "最高的两个团队的团队果核之和" },
    { key: 6, name: "小区果核", reward: "", request: "除最高的两个团队的团队果核外 其他团队果核之和;如果小区果核大于大区果核则小区果核成为大区果核" }
];
const STAR_LEVEL_DETAILS2 = {
    title: '团队规则',
    rules: [
        {
            key: 0, title: "一星达人", text: `奖励：一个初级任务且全球交易手续费10%且奖励哟帮放单全球手续费10% \r\n要求：直推实名20人且团队果核达到500点`
        },
        {
            key: 1, title: "二星达人", text: "奖励:一个中级任务且全球交易手续费20%且奖励哟帮放单全球手续费20% \r\n要求:直推实名20人且团队果核2000点且小区果核400点且直推中包含两个一星",
        },
        {
            key: 2, title: "三星达人", text: "奖励:一个高级任务且全球交易手续费15%且奖励哟帮放单全球手续费15% \r\n要求:直推实名20人且团队果核8000点且小区果核2000点且直推中包含两个二星",
        },
        {
            key: 3, title: "四星达人", text: "奖励:一个超级任务且全球交易手续费10%且奖励哟帮放单全球手续费10% \r\n要求:直推实名20人且团队果核100000点且小区果核25000点且直推中包含两个三星",
        },
        {
            key: 4, title: "五星达人", text: "奖励:一个超级任务且全球交易手续费5%且奖励哟帮放单全球手续费5% \r\n要求:直推实名20人且团队果核1000000点且小区果核250000点且直推中包含两个四星",
        },
        { key: 5, title: "团队果核", text: "团队实名成员越多团队果核越多 团队成员开任务越多团队果核越多 团队成员任务到期则相应减去团队果核" },
        { key: 6, title: "大区果核", text: "最高的两个团队的团队果核之和" },
        { key: 7, title: "小区果核", text: "除最高的两个团队的团队果核外 其他团队果核之和;如果小区果核大于大区果核则小区果核成为大区果核" }
    ]
};
const CandyHDetail = {
    title: '果核规则',
    rules: [
        { key: '0', title: `果核价值`, text: `1、果核越多产量越高` },
        {
            key: '1', title: `果核来源`, text: `1.任务果核(任务商店兑换)\r\n2.推广果核加成\r\n邀请的下级实名认证通过（下级任务的5%）`
        },
    ]
};
// 1. 团队果核：团队实名成员越多团队果核越多，团队成员开任务越多团队果核越多，团队成员无任务则相应减去团队果核
// 2. 大区果核：最高的两个团队的团队果核之和
// 3. 小区果核：除最高的两个团队的团队果核外，其他团队果核之和
const TEAM_CANDY = [
    { key: 0, name: "团队果核", content: "团队实名成员越多团队果核越多 团队成员开任务越多团队果核越多 团队成员无任务则相应减去团队果核" },
    { key: 1, name: "大区果核", content: "最高的两个团队的团队果核之和" },
    { key: 2, name: "小区果核", content: "除最高的两个团队的团队果核外 其他团队果核之和;如果小区果核大于大区果核则小区果核成为大区果核" }
];
// 会员等级
...
const TRANSACTION_STATISTICS = [
    ...
    { key: "todayAmount", title: "挂单量", description: "今日发布买单单数", unit: "" },
